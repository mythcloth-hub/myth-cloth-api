...
/**
 * Entity that links a {@link com.mesofi.mythclothapi.collectors.Collector} to
 * an external authentication provider identity.
 *
 * <p>
 * Each record is unique by provider and provider user id.
 */
@Entity
@Getter
@Setter

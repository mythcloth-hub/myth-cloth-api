 ...
 *
 * <p>
 * Provides query methods to retrieve figurine events by their associated
 * figurine or by a combination of event ID and figurine ID. Uses Spring Data
 * JPA to automatically generate the required queries.
 */
@Repository

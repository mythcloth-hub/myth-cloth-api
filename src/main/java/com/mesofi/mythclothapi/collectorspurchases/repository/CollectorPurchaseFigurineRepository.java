...
/**
 * Repository for managing figurine line items associated with collector
 * purchases.
 *
 * <p>
 * A {@link CollectorPurchaseFigurine} represents an individual figurine entry
 * within a purchase, including details such as quantity, price paid, and
 * purchase type.
 *
 * <p>
 * This repository provides operations to retrieve purchase line items by their
 * parent purchase relationship or by purchase identifiers.
 */
@Repository

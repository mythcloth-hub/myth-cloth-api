 ...
 *
 * <p>
 * This object contains the persisted purchase information including order
 * details, totals, shipping information, and the list of figurines included in
 * the purchase.
 *
 * <p>
 * The response represents historical purchase data and is independent from the
 * collector's current collection inventory.
 *
 * <p>
 * Calculated fields such as total amount and total figurines are derived from
 ...
 * @param orderNumber
 *            seller-provided order identifier
 * @param currency
 *            currency used for the transaction
 * @param totalAmount
 *            total purchase amount calculated from all line items
 * @param totalFigurines
 *            total number of figurines included in the purchase
 ...
 * @param shippedDate
 *            date when the purchase was shipped
 * @param deliveredDate
 *            date when the purchase was delivered
 * @param lineItems

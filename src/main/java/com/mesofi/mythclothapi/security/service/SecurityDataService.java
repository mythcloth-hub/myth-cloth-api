...
public class SecurityDataService {
    ...
    private static final List<String> AVAILABLE_PERMISSIONS = List.of(Permissions.ANNIVERSARIES_CREATE,
            ...
            Permissions.FIGURINES_STORES_ASSIGN, Permissions.FIGURINES_STORES_IGNORE, Permissions.FIGURINES_STORES_READ,
    ...
    private static final Map<RoleType, List<String>> ROLE_PERMISSIONS_MAP = Map.of(
            ...
            List.of(Permissions.ANNIVERSARIES_CREATE, Permissions.ANNIVERSARIES_DELETE, Permissions.ANNIVERSARIES_READ,
                    ...
                    Permissions.COLLECTIONS_FIGURINES_ADD, Permissions.COLLECTIONS_FIGURINES_DELETE,
                    Permissions.COLLECTIONS_FIGURINES_READ, Permissions.COLLECTIONS_READ,
                    Permissions.COLLECTIONS_UPDATE, Permissions.DISTRIBUTORS_CREATE, Permissions.DISTRIBUTORS_DELETE,
                    Permissions.DISTRIBUTORS_READ, Permissions.DISTRIBUTORS_UPDATE, Permissions.FIGURINES_CREATE,

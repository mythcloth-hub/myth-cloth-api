 ...
 *            collection figurine identifier
 * @param figurineId
 *            figurine identifier
 * @param name
...
public record CollectorCollectionFigurineResp(long collectionFigurineId, long figurineId, String name,
        ReleaseStatus releaseStatus, String notes, String imageUrl, @JsonProperty("isCollected") boolean isCollected,
        int ownedQuantity) {
}

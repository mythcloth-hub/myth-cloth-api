 ...
 *
 * <p>
 * Images are treated as sub-resources of a figurine and are identified by their
 * URL rather than a standalone identifier.
 *
 * <p>
 * All incoming requests are validated before being delegated to
 * {@link FigurineImageService}.
 */
@Slf4j
@Validated
@RestController
...
public class FigurineImageController {
	 ...
	 *
	 * <p>
	 * The response is returned with HTTP {@code 201 Created}.
	 *
	 * @param figurineId
	 *            identifier of the target figurine
	 * @param figurineImageRequest
	 ...
	 *
	 * <p>
	 * The type of images returned is controlled by the {@code isOfficialImage}
	 * query parameter.
	 *
	 * @param figurineId
	 *            identifier of the target figurine
	 ...
	 *
	 * <p>
	 * The image to remove is identified by its URL and whether it belongs to the
	 * official or non-official image collection.
	 *
	 * <p>
	 * If the image does not exist, an appropriate domain exception is thrown.
	 *
	 * @param figurineId
	 *            identifier of the target figurine
	 * @param imageUrl

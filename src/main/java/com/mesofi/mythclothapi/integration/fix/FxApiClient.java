...
/**
 * HTTP client wrapper for retrieving foreign exchange rates from
 * {@code fxapi.app}.
 *
 * <p>
 * This component exposes a focused API used by the service layer to fetch a
 * conversion rate between two ISO-4217 currency codes.
 */
@Component

...
public class CurrencyConversionService {
     ...
     *
     * @param fxApiClient
     *            client used to fetch fresh exchange rates
     */
     ...
     *
     * <p>
     * If source and target currencies are the same, the original amount is returned
     * unchanged. Otherwise, the result is rounded to two decimal places using
     * {@link RoundingMode#HALF_UP}.
     *
     * @param amount
     *            amount to convert
     * @param from
     *            source currency code (for example, {@code USD})
     * @param to
    ...
    /**
     * Retrieves a rate from cache when available and valid, or fetches and caches a
     * fresh rate.
     */

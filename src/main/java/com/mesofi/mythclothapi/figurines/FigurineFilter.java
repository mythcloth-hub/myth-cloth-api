 ...
 *            figurine id's
 * @param name
 *            figurine name or partial name to match
 * @param lineUpId
 *            lineup identifier to filter by
 * @param seriesId
 *            series identifier to filter by
 * @param groupIds
 *            group identifiers to filter by
 ...
 * @param oce
 *            whether the figurine is an OCE variant
 * @param revival
 *            whether the figurine is a revival release
 * @param plainCloth
 *            whether the figurine has plain cloth
 * @param broken
 *            whether the figurine is a broken version
 * @param golden
 *            whether the figurine is a golden version
 * @param gold
 *            whether the figurine is gold-colored
 * @param manga
 *            whether the figurine is a manga variant
 * @param set
 ...
 */
public record FigurineFilter(List<Long> figurineIds, String name, Long lineUpId, Long seriesId, List<Long> groupIds,

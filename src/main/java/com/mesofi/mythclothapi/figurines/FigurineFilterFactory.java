 ...
 *
 * <p>
 * This class centralizes the logic for building figurine filter records,
 * ensuring consistent parameter validation and name normalization across all
 * controllers.
 */
public final class FigurineFilterFactory {
     ...
     *
     * <p>
     * All functionality is exposed through static factory methods.
     */
     ...
     *
     * <p>
     * The name parameter is trimmed and validated to have at least 3 characters. If
     * it does not meet this requirement, an empty string is used instead.
     *
     * @param figurineIds
     *            optional figurine identifier list for filtering by collector's
     *            figurines (if applicable)
     * @param name

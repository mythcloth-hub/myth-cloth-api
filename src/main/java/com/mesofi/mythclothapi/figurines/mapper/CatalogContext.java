...
public record CatalogContext(List<Distributor> distributors, List<Distribution> distributions, List<LineUp> lineUps,
		List<Series> series, List<Group> groups, List<Anniversary> anniversaries) {
}

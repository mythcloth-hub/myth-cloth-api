...
/**
 * Represents a paginated response containing figurine data and pagination
 * metadata.
 *
 * <p>
 * This DTO is used to return paginated figurine search results while exposing
 * additional information about the number of collectable figurines available.
 *
 * <p>
 ...
 *
 * @param content
 *            list of figurines included in the current page
 * @param page
 *            current page index (zero-based)
 * @param size
 *            number of elements requested per page
 * @param totalElements
 *            total number of figurines matching the search criteria
 * @param totalCollectableElements
 *            total number of figurines considered collectable
 * @param totalPages

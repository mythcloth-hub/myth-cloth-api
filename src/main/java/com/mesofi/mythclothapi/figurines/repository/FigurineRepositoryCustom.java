 ...
 *
 * <p>
 * This interface provides query operations that extend the default Spring Data
 * repository capabilities. Implementations may use custom query strategies to
 * support advanced filtering, sorting, and pagination requirements.
 *
 * <p>

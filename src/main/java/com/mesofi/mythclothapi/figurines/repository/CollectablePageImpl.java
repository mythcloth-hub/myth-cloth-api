...
/**
 * Custom implementation of a paginated response that extends Spring Data's
 * {@link PageImpl} to include the total number of collectable items.
 *
 * <p>
 * This class is useful when the pagination result needs to expose additional
 * metadata related to collectable figurines, while preserving the standard
 * {@link org.springframework.data.domain.Page} behavior.
 *
 * @param <T>
 *            the type of elements contained in this page
 */
@Getter

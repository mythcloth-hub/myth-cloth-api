 ...
 *            total figurines matching the filter
 * @param countByLineUp
 *            counts grouped by line-up description
 * @param countBySeries
 *            counts grouped by series description
 * @param countByGroup
 *            counts grouped by group description
 * @param countByAnniversary
 *            counts grouped by anniversary description
 * @param totalByReleaseStatus
 *            counts grouped by computed release status
 */

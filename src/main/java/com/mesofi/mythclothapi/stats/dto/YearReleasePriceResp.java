 ...
 * @param year
 *            release year
 * @param averageReleasePrice
 *            average release price for the year
 * @param highestReleasePrice
 *            highest release price for the year
 * @param lowestReleasePrice
 *            lowest release price for the year
 * @param highestPriceFigurines
 *            figurine reference for the highest release price
 * @param lowestPriceFigurines
 *            figurine reference for the lowest release price
 * @param releaseCount

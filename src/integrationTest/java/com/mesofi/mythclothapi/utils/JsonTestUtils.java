 ...
 *
 * <p>
 * This class is intended exclusively for test code. It removes
 * non-deterministic fields (such as database-generated identifiers and
 * timestamps) from JSON payloads to allow stable and repeatable assertions
 * against "golden" expected JSON files.
 *
 * <p>
 ...
 * <li>Removes root-level and nested timestamp fields ({@code createdAt},
 * {@code updatedAt})
 * <li>Performs a recursive traversal of objects and arrays
 * </ul>
 *
 * <p>
 * The resulting JSON structure preserves semantic content while eliminating
 * values that cannot be reliably asserted in automated tests.
 */
public final class JsonTestUtils {
     ...
     *
     * <p>
     * If the provided node is not an object, the method returns immediately.
     * Otherwise, it recursively removes known volatile fields ({@code id},
     * {@code createdAt}, {@code updatedAt}) from all levels of the JSON structure.
     *
     * <p>
     * This method mutates the provided {@link JsonNode} in place.
     *
     * @param node
     *            the root JSON node to normalize; may be {@code null}
     */
     ...
     *
     * <p>
     * Primitive nodes are ignored.
     *
     * @param node
     *            the current JSON node being traversed
     * @param propertyName
     *            the field name to remove at any depth
     */

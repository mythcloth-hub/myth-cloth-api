...
public final class TestJwtFactory {
	...
	public String createAdminToken() {
		...
		JwtClaimsSet claims = JwtClaimsSet.builder().subject(TEST_USER).issuer(TEST_ISSUER).issuedAt(Instant.now())
				.expiresAt(Instant.now().plus(TOKEN_EXPIRATION_HOURS, ChronoUnit.HOURS)).claim(CLAIM_PROVIDER, FACEBOOK) // or
																															// GOOGLE,
																															// arbitrary
																															// provider
																															// for
				...
				.claim(CLAIM_PERMISSIONS, List.of(CATALOG_WRITE_PERMISSION, CATALOG_READ_PERMISSION,
						...
						ROLES_WRITE_PERMISSION, ROLES_READ_PERMISSION, ROLES_PERMISSION_ASSIGN_PERMISSION,
						ROLES_PERMISSION_READ_PERMISSION, ROLES_PERMISSION_SYNC_PERMISSION,
						DISTRIBUTORS_WRITE_PERMISSION, DISTRIBUTORS_READ_PERMISSION, DISTRIBUTORS_UPDATE_PERMISSION,
						DISTRIBUTORS_DELETE_PERMISSION, FIGURINES_WRITE_PERMISSION, FIGURINES_UPDATE_PERMISSION,
						FIGURINES_EVENT_ADD_PERMISSION, FIGURINES_EVENT_READ_PERMISSION,

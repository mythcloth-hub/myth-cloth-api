    ...
    public String createAdminToken() {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder().subject(TEST_USER).issuer(TEST_ISSUER).issuedAt(Instant.now())
                ...
                .claim(CLAIM_PERMISSIONS, List.of(CATALOG_WRITE_PERMISSION, CATALOG_READ_PERMISSION,
                        CATALOG_UPDATE_PERMISSION, CATALOG_DELETE_PERMISSION, PERMISSIONS_WRITE_PERMISSION,
                        PERMISSIONS_READ_PERMISSION, PERMISSIONS_DELETE_PERMISSION, ROLES_WRITE_PERMISSION,
                        ROLES_READ_PERMISSION, ROLES_PERMISSION_ASSIGN_PERMISSION, ROLES_PERMISSION_READ_PERMISSION,

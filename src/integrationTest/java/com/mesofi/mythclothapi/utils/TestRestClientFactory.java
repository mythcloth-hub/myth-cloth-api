...
/**
 * Factory responsible for creating configured {@link RestClient} instances for
 * integration tests.
 *
 * <p>
 * This factory creates clients preconfigured with:
 *
 * <ul>
 ...
 *
 * <p>
 * This class is intended to simplify integration tests by avoiding repeated
 * RestClient and JWT setup code.
 */
public class TestRestClientFactory {
     ...
     *
     * @param jwtEncoder
     *            encoder used to generate JWT tokens for test authentication
     */
     ...
     * <li>Can be used to call secured endpoints requiring administrative
     * privileges.
     * </ul>
     *
     * @param port
     *            the dynamically assigned test server port
     * @param contextPath
     *            the application context path configured for the test environment
     * @return a configured {@link RestClient} instance ready to execute
    ...
    public RestClient createAdminClient(int port, String contextPath) {
        ...
        return RestClient.builder().baseUrl("http://localhost:%s%s".formatted(port, contextPath))

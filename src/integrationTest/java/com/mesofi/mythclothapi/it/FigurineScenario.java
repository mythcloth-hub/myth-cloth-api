 ...
 *
 * <p>
 * This annotation is applied to test methods and is processed by
 * {@link FigurineScenarioExtension} to drive scenario execution.
 *
 * <p>
 * A figurine scenario defines:
 *
 * <ul>
 * <li>A human-readable scenario name for logging and traceability
 * <li>One or more {@link ScenarioRequest} definitions describing request and
 * expected response payloads
 * </ul>
 *
 * <p>
 * Each scenario request references a JSON fixture and may declare catalog
 * selection metadata used to dynamically resolve and inject entity identifiers
 * into the payload.
 */

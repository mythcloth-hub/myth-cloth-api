 ...
 *
 * <p>
 * Each fixture type maps to a dedicated folder on disk where JSON files are
 * stored. The folder name is used by the test infrastructure to resolve the
 * correct fixture path at runtime.
 */

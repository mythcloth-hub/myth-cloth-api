...
class FigurineImportPropertiesTest {
    ...
    void bindProperties_shouldPopulateFields_whenSpringContextLoads() {
        // Assert
        assertThat(properties.getDriveUrl()).isEqualTo("https://drive.google.com/uc?export=download&id=%s");
    ...
    void buildUrl_shouldReturnResolvedUrl_whenValuesAreBoundFromSpringProperties() {
        ...
        // Assert
        assertThat(resolvedUrl).isEqualTo("https://drive.google.com/uc?export=download&id=catalog-file-id");
    }
}

...
class FigurineReleaseStatusResolverTest {
    ...
    void resolve_shouldReturnRumoredWhenDistributorHasNoDates() {
        Figurine figurine = figurine(distributor(null, null));
    ...
    void resolve_shouldReturnPrototypeOrUnreleasedWhenOnlyAnnouncementExists() {
        Figurine prototype = figurine(distributor(LocalDate.now().minusYears(2), null));
        Figurine unreleased = figurine(distributor(LocalDate.now().minusYears(6), null));
    ...
    void resolve_shouldReturnUnreleasedAtExactlyFiveYearsSinceAnnouncement() {
        Figurine unreleased = figurine(distributor(LocalDate.now().minusYears(5), null));
    ...
    void resolve_shouldReturnReleasedWhenReleaseDateMatchesToday() {
        Figurine releasedToday = figurine(distributor(LocalDate.now().minusYears(1), LocalDate.now()));
    ...
    void resolve_shouldReturnAnnouncedOrReleasedBasedOnReleaseDate() {
        Figurine announced = figurine(distributor(LocalDate.now().minusYears(1), LocalDate.now().plusDays(1)));
        Figurine released = figurine(distributor(LocalDate.now().minusYears(1), LocalDate.now().minusDays(1)));

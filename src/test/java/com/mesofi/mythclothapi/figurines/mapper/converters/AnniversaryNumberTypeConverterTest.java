...
class AnniversaryNumberTypeConverterTest {
	...
	private final ExposedAnniversaryNumberTypeConverter converter = new ExposedAnniversaryNumberTypeConverter();
	...
	void convert_shouldParseYearAndType_whenTypeIsProvidedInAnotherEnumValue() {
		...
		assertThat(converted.getAnniversaryType()).isEqualTo(AnniversaryType.TAMASHII_NATIONS_WORLD_TOUR);
	}

	private static final class ExposedAnniversaryNumberTypeConverter extends AnniversaryNumberTypeConverter {

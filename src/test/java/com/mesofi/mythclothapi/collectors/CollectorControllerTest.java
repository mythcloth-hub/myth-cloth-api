...
class CollectorControllerTest {
    ...
    void login_shouldReturn400_whenRequestBodyIsMissing() throws Exception {
        ...
        mockMvc.perform(post("/collectors/auth/{provider}", "google")).andExpect(status().isBadRequest())
    ...
    void login_shouldReturn415_whenContentTypeIsMissing() throws Exception {
        ...
        mockMvc.perform(post("/collectors/auth/{provider}", "google").content("{}"))
    ...
    void login_shouldReturn200_whenRequestIsValid() throws Exception {
        ...
        mockMvc.perform(post("/collectors/auth/{provider}", "google").contentType(MediaType.APPLICATION_JSON)

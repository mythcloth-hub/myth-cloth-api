...
class CollectorInvalidTokenExceptionTest {
    ...
    void constructor_shouldSetMessageCorrectly_whenCreated() {
        // Arrange & Act
        CollectorInvalidTokenException exception = new CollectorInvalidTokenException("Facebook token is invalid");
    ...
    void getStatus_shouldReturnUnauthorized_whenCalled() {
        // Arrange
        CollectorInvalidTokenException exception = new CollectorInvalidTokenException("Token validation failed");

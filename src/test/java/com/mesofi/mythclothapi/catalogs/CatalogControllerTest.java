...
class CatalogControllerTest {
    ...
    void createCatalog_shouldReturn400_whenRequestBodyIsMissing() throws Exception {
        ...
        mockMvc.perform(post("/catalogs/groups")).andExpect(status().isBadRequest()).andExpect(jsonPath("$.detail")
                .value("Required request body is missing: public org.springframework.http.ResponseEntity<com.mesofi.mythclothapi.catalogs.dto.CatalogResp> com.mesofi.mythclothapi.catalogs.CatalogController.createCatalog(com.mesofi.mythclothapi.catalogs.dto.CatalogType,com.mesofi.mythclothapi.catalogs.dto.CatalogReq)"))
    ...
    void createCatalog_shouldReturn415_whenContentTypeIsMissing() throws Exception {
        ...
        mockMvc.perform(post("/catalogs/groups").content("{}")).andExpect(status().isUnsupportedMediaType())
    ...
    void createCatalog_shouldReturn400_whenRequestBodyFailsValidation() throws Exception {
        ...
        mockMvc.perform(post("/catalogs/groups").contentType(MediaType.APPLICATION_JSON).content("{}"))
    ...
    void createCatalog_shouldReturn400_whenDescriptionExceedsMaxLength() throws Exception {
        ...
        mockMvc.perform(post("/catalogs/groups").contentType(MediaType.APPLICATION_JSON).content(requestBody))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.detail").value("Your request parameters didn't validate"))
                .andExpect(jsonPath("$.instance").value("/catalogs/groups"))
                .andExpect(jsonPath("$.status").value("400")).andExpect(jsonPath("$.title").value("Validation Failed"))
                .andExpect(jsonPath("$.timestamp").exists())
                .andExpect(jsonPath("$.errors.description").value("description must not exceed 100 characters"));
    ...
    void createCatalog_shouldReturn400_whenCatalogTypeIsUnknown() throws Exception {
        ...
        mockMvc.perform(post("/catalogs/unknown").contentType(MediaType.APPLICATION_JSON)
                .content("{\"description\":\"Gold Saints\"}")).andExpect(status().isBadRequest())
                ...
                .andExpect(jsonPath("$.status").value("400")).andExpect(jsonPath("$.title").value("Validation Failed"))
                .andExpect(jsonPath("$.timestamp").exists()).andExpect(jsonPath("$.error").value(
    ...
    void createCatalog_shouldReturn201AndLocationHeader() throws Exception {
        ...
        mockMvc.perform(post("/catalogs/groups").contentType(MediaType.APPLICATION_JSON)
                ...
                .andExpect(jsonPath("$.id").value(1L)).andExpect(jsonPath("$.description").value("Gold Saints"));
    ...
    void retrieveCatalog_shouldReturn200_whenCatalogExists() throws Exception {
        ...
        mockMvc.perform(get("/catalogs/groups/{id}", 7L)).andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(7L)).andExpect(jsonPath("$.description").value("Asgard"));
    ...
    void retrieveCatalogs_shouldReturn200_whenCatalogEntriesExist() throws Exception {
        ...
        mockMvc.perform(get("/catalogs/groups")).andExpect(status().isOk()).andExpect(jsonPath("$.length()").value(2))
                .andExpect(jsonPath("$[0].id").value(1L)).andExpect(jsonPath("$[0].description").value("Bronze Saints"))
                .andExpect(jsonPath("$[1].id").value(2L)).andExpect(jsonPath("$[1].description").value("Asgard"));
    ...
    void retrieveCatalogs_shouldReturn200WithEmptyList_whenCatalogHasNoEntries() throws Exception {
        ...
        mockMvc.perform(get("/catalogs/groups")).andExpect(status().isOk()).andExpect(jsonPath("$.length()").value(0));
    ...
    void updateCatalog_shouldReturn200_whenRequestIsValid() throws Exception {
        ...
        mockMvc.perform(put("/catalogs/groups/{id}", 11L).contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(11L)).andExpect(jsonPath("$.description").value("Athena Army"));
    ...
    void updateCatalog_shouldReturn400_whenRequestBodyFailsValidation() throws Exception {
        ...
        mockMvc.perform(put("/catalogs/groups/{id}", 11L).contentType(MediaType.APPLICATION_JSON).content("{}"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.detail").value("Your request parameters didn't validate"))

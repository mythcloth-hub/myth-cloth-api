...
class CurrencyConversionServiceTest {
    ...
    void convert_shouldRefreshExpiredCachedRate() throws Exception {
        ...
        ConcurrentMap<String, Object> cache = (ConcurrentMap<String, Object>) ReflectionTestUtils.getField(service,
                "cache");
    ...
    private Object expiredCachedRate(BigDecimal rate) throws Exception {
        Class<?> cachedRateClass = Class
                .forName("com.mesofi.mythclothapi.integration.fix.CurrencyConversionService$CachedRate");
        Constructor<?> constructor = cachedRateClass.getDeclaredConstructor(BigDecimal.class, Instant.class);
